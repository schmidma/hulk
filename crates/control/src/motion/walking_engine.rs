...
impl WalkingEngine {
    ...
    fn calculate_return_offset(
        ...
        let left_sole =
            robot_to_walk * forward::left_sole_to_robot(&last_actuated_joints.left_leg).as_pose();
        let right_sole =
            robot_to_walk * forward::right_sole_to_robot(&last_actuated_joints.right_leg).as_pose();
